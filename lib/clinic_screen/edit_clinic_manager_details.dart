...
class EditClinicManagerDetail extends StatefulWidget {
  ...
  @override
  State<EditClinicManagerDetail> createState() => _EditClinicManagerDetailState();
}
...
class _EditClinicManagerDetailState extends State<EditClinicManagerDetail> {
  ...
  void initState() {
    ...
    medicalManagerNumberController.text = widget.data.medicalDirectorNumber ?? "";
                          ...
                          child:  Align(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Text("Edit Clinic Manager Detail",style: GoogleFonts.lato(fontSize: 28,fontWeight: FontWeight.w600,color: Colors.white,),),
                                ],
                              ))
                      ),
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text("Edit Clinic Manager Details",style: GoogleFonts.lato(fontSize: 19,fontWeight: FontWeight.w600),),
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      if (financialManagerFile==null && financeFile.isEmpty)
                                        InkWell(
                                          onTap: () {
                                            _pickImage3();
                                          },
