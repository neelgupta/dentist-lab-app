          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    /// 1 online
                    cheque == false && cash == false
                        ? GestureDetector(
                            onTap: () {
                              setState(() {
                                onlineMakePayment = !onlineMakePayment;
                                cash = false;
                                cheque = false;
                              });
                            },
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    SizedBox(
                                        height: height * 0.04,
                                        child: onlineMakePayment
                                            ? Image.asset(
                                                color: const Color(0xff116D6E),
                                                "assets/image/paymentDown .png",
                                              )
                                            : Image.asset(
                                                color: onlineMakePayment
                                                    ? const Color(0xff116D6E)
                    ...
                    ///2 Cash
                    onlineMakePayment == false && cheque == false
                        ? GestureDetector(
                            onTap: () {
                              setState(() {
                    ...
                    onlineMakePayment == false && cash == false
                        ? GestureDetector(
                            onTap: () {
                              setState(() {
                                onlineMakePayment = false;
              ...
              Padding(
                padding: EdgeInsets.symmetric(horizontal: height * 0.02),
                child: commonButton(
                    context, 'Pay 500', 13, FontWeight.w700, Colors.white, () {
                  Navigator.push(context, MaterialPageRoute(
                    builder: (context) {
                      return const PaymentSuccessfully();
                    },
                  ));
                }),
              ),
