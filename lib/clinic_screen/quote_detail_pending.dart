        ...
        body: SizedBox(
          ...
          child: isLoading?Center(child: loader()):Column(
            ...
            children: [
              ...
              Expanded(
                child: quotesData==null?const Center(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      InkWell(
                                        onTap: () {
                                          acceptProposal(proposalId: proposals[index].id);
                                        },
                                        child: Container(
                                          padding: EdgeInsets.symmetric(horizontal: width * 0.03, vertical: 3),
                                          decoration: BoxDecoration(
                                  ...
                                  Row(
                                    children: [
                                      Expanded(
                                        child: Text(
                                          proposals[index].labDetails![0].description ?? "",
                                      ...
                                      InkWell(
                                        onTap: () {
                                          Navigator.push(context, MaterialPageRoute(builder: (context) {
                                            return PublicProfileScreen(labId: proposals[index].labDetails![0].id ?? "");
                                          },));
                                        },
                                        child: Text(
                                          "Show Profile",
