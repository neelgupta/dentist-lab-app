...
class AdvancePaymentDoneScreen extends StatefulWidget {
  const AdvancePaymentDoneScreen({Key? key}) : super(key: key);

  @override
  State<AdvancePaymentDoneScreen> createState() => _AdvancePaymentDoneScreenState();
}

class _AdvancePaymentDoneScreenState extends State<AdvancePaymentDoneScreen> {
  @override
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children:  [
                    ...
                    Text("75 AED received",style: GoogleFonts.lato(fontSize: 19,fontWeight: FontWeight.w600 ),textAlign: TextAlign.center),
                    SizedBox(height: height*0.012,),
                    Text("Advance 30% payment received\n successfully \n Continue with job.",
