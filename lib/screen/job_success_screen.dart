...
class JobSuccessScreen extends StatefulWidget {
  const JobSuccessScreen({Key? key}) : super(key: key);
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children:  [
                    ...
                    Text("Lorem Ipsum has been the\nindustry's standard dummy text\never since", style: GoogleFonts.lato(fontSize: 15,fontWeight: FontWeight.w500,
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: TextButton(
                      ...
                      child: Text("Back To Home",style: GoogleFonts.lato(fontSize: 15,fontWeight: FontWeight.w500,color: Colors.white))),
                ),
              ),
