...
class _ResetPasswordScreenState extends State<ResetPasswordScreen> {
                  ...
                  child: Column(
                    ...
                    children:  [
                      ...
                      Text("Enter the email address associated with your account and we will send you a code to reset your password.",
                          style: GoogleFonts.lato(fontSize: 14,fontWeight: FontWeight.w500,color: const Color(0xFF707070)),maxLines: 3,textAlign: TextAlign.start),
  ...
  forgotPassword()async{
    ...
    var postUri = Uri.parse(ApiServices.forgotPasswordApi);
      ...
      Utils.logAPIResponse(apiName: ApiServices.forgotPasswordApi,response: response,function: "forgotPassword");
      Navigator.pop(context);
      if (response.statusCode == 200) {
        Map map = jsonDecode(response.body);
        if (map["status"] == 200) {
          Utils.showSuccessToast(map["message"]);
          Navigator.push(context,MaterialPageRoute(builder: (context) => SubmitCodeScreen(userId: map['UserId'],emailId: emailController.text,)));
        } else {
