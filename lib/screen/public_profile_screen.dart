...
class _PublicProfileScreenState extends State<PublicProfileScreen> {
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                          image: profile != null
                                              ...
                                              : DecorationImage(
                                                  image: NetworkImage(labProfileData!.labData![0].userDetails![0].profileImage ?? ""),
                                            fit: BoxFit.fill
                                          ),
                              ...
                              InkWell(
                                  onTap: () {
                                    Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                          builder: (context) =>
                                              EditProfileScreen(userDetails: labProfileData!.labData![0].userDetails![0]),
                          ...
                          Visibility(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                if( (labProfileData!.labData![0].workingHours ?? []).isNotEmpty && (labProfileData!.labData![0].workingHours![0].dayDetails ?? []).isNotEmpty)
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    SizedBox(
                                    ...
                                    ListView.builder(
                                      ...
                                      shrinkWrap: true,
                                      itemCount: labProfileData!.labData![0].workingHours![0].dayDetails!.length,
                                      itemBuilder: (context, index) {
                                        return Container(
                                          margin: EdgeInsets.symmetric(vertical: height*0.008),
                                          child: Row(
                                            children: [
                                              Text(labProfileData!.labData![0].workingHours![0].dayDetails![index].day ?? "",style: GoogleFonts.lato(fontSize: 14,fontWeight: FontWeight.w400),),
                                              const Spacer(),
                                              Text((labProfileData!.labData![0].workingHours![0].dayDetails![index].isOpen ?? false)?"${labProfileData!.labData![0].workingHours![0].dayDetails![index].startTime ?? ""} - ${labProfileData!.labData![0].workingHours![0].dayDetails![index].endTime ?? ""}":"Close",style: GoogleFonts.lato(fontSize: 14,fontWeight: FontWeight.w400,color: const Color(0xFF707070)),),
                                            ],
                                          ),
                                        );
                                      },),
                          ...
                          SizedBox(
                            height: height * 0.26,
                            child: labProfileData!.labData![0].labServices!.isEmpty ? const Center(child: Text("No Service Found !!"),) :  ListView.builder(
                              itemCount:
  ...
  labGetProfileData() async {
    ...
    if (response.statusCode == 200) {
      ...
      Utils.setFirstName(labProfileData!.labData![0].userDetails![0].firstName ?? "");
      Utils.setLastName(labProfileData!.labData![0].userDetails![0].lastName ?? "");
      Utils.setProfileImage(labProfileData!.labData![0].userDetails![0].profileImage ?? "");
