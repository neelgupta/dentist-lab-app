...
class _DatePickerScreenState extends State<DatePickerScreen> {
  ...
  var openingTime = "03:45";
  var closingTime = "17:45";
  bool Onoff = false;
                                    ...
                                    children: [
                                      SizedBox(
                                        ...
                                        child: CupertinoPicker(
                                          ...
                                          children: startTime.map((text) => Center(
                                            child: Container(
                                              alignment: Alignment.center,
                                              decoration: BoxDecoration(
                                              ),
                                    ...
                                    child: TextButton(
                                        onPressed: () {
                                          setState(() {
                                            ...
                                            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => ManageProfile4(),));
                                          });
                                          //
                                        },
